...
_METADATAV1_HEADERSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='MetadataV1.HeadersEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='MetadataV1.HeadersEntry.value',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_METADATAV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='publisher',
            full_name='MetadataV1.publisher',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp',
            full_name='MetadataV1.timestamp',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_PAYLOADV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='format_version',
            full_name='PayloadV1.format_version',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
