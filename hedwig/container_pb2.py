...
MetadataV1 = _reflection.GeneratedProtocolMessageType('MetadataV1', (_message.Message,), {
  ...
  'HeadersEntry' : _reflection.GeneratedProtocolMessageType('HeadersEntry', (_message.Message,), {
    ...
    '__module__' : 'hedwig.container_pb2'
