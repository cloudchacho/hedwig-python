...
message_options = _descriptor.FieldDescriptor(
    ...
    full_name='hedwig.message_options',
    index=0,
    number=51235,
    type=11,
    cpp_type=10,
...
_MESSAGEOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='major_version',
            full_name='hedwig.MessageOptions.major_version',
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='minor_version',
            full_name='hedwig.MessageOptions.minor_version',
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name='message_type',
            full_name='hedwig.MessageOptions.message_type',
            index=2,
            number=3,
            type=9,
            cpp_type=9,
