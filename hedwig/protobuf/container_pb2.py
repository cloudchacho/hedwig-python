...
_METADATAV1_HEADERSENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='key',
            full_name='hedwig.MetadataV1.HeadersEntry.key',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='value',
            full_name='hedwig.MetadataV1.HeadersEntry.value',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_METADATAV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='publisher',
            full_name='hedwig.MetadataV1.publisher',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='timestamp',
            full_name='hedwig.MetadataV1.timestamp',
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='headers',
            full_name='hedwig.MetadataV1.headers',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
...
_PAYLOADV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='format_version',
            full_name='hedwig.PayloadV1.format_version',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='metadata',
            full_name='hedwig.PayloadV1.metadata',
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name='schema',
            full_name='hedwig.PayloadV1.schema',
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='data',
            full_name='hedwig.PayloadV1.data',
            index=4,
            number=5,
            type=11,
            cpp_type=10,
...
MetadataV1 = _reflection.GeneratedProtocolMessageType(
    'MetadataV1',
    (_message.Message,),
    {
...
PayloadV1 = _reflection.GeneratedProtocolMessageType(
    'PayloadV1',
    (_message.Message,),
    {
