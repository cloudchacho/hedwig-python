...
_TRIPCREATEDV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='vehicle_id',
            full_name='TripCreatedV1.vehicle_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='user_id',
            full_name='TripCreatedV1.user_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_TRIPCREATEDV2 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='vehicle_id',
            full_name='TripCreatedV2.vehicle_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_DEVICECREATEDV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='device_id',
            full_name='DeviceCreatedV1.device_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name='user_id',
            full_name='DeviceCreatedV1.user_id',
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_VEHICLECREATEDV1 = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='vehicle_id',
            full_name='VehicleCreatedV1.vehicle_id',
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
TripCreatedV1 = _reflection.GeneratedProtocolMessageType(
    'TripCreatedV1',
    (_message.Message,),
    {
        'DESCRIPTOR': _TRIPCREATEDV1,
        '__module__': 'protobuf_pb2'
        # @@protoc_insertion_point(class_scope:TripCreatedV1)
    },
)
_sym_db.RegisterMessage(TripCreatedV1)

TripCreatedV2 = _reflection.GeneratedProtocolMessageType(
    'TripCreatedV2',
    (_message.Message,),
    {
        'DESCRIPTOR': _TRIPCREATEDV2,
        '__module__': 'protobuf_pb2'
        # @@protoc_insertion_point(class_scope:TripCreatedV2)
    },
)
_sym_db.RegisterMessage(TripCreatedV2)

DeviceCreatedV1 = _reflection.GeneratedProtocolMessageType(
    'DeviceCreatedV1',
    (_message.Message,),
    {
        'DESCRIPTOR': _DEVICECREATEDV1,
        '__module__': 'protobuf_pb2'
        # @@protoc_insertion_point(class_scope:DeviceCreatedV1)
    },
)
_sym_db.RegisterMessage(DeviceCreatedV1)

VehicleCreatedV1 = _reflection.GeneratedProtocolMessageType(
    'VehicleCreatedV1',
    (_message.Message,),
    {
        'DESCRIPTOR': _VEHICLECREATEDV1,
        '__module__': 'protobuf_pb2'
        # @@protoc_insertion_point(class_scope:VehicleCreatedV1)
    },
)
