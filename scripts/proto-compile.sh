...
cd tests/schemas && protoc -I/usr/local/lib/protobuf/include -I. -I../.. --python_out=protos/ --mypy_out=protos/ protobuf.proto protobuf_minor_versioned.proto protobuf_bad.proto && cd -
cd examples && protoc -I/usr/local/lib/protobuf/include -I. -I.. --python_out=protos/ --mypy_out=protos/ schema.proto && cd -
